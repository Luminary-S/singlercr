...
class Kinematic:
    def __init__(self):
        ...
        self.d6 = 0
        self.urtype = "ur3"
        self.d1, self.a2, self.a3, self.d4,self.d5,self.d6 =self.set_ur_params(self.urtype)

    def set_urtype(self, type):
        self.urtype = type
        self.d1, self.a2, self.a3, self.d4, self.d5, self.d6 = self.set_ur_params(self.urtype)
    ...
    def set_ur_params(self, UR_ROBOT):
        if UR_ROBOT =="ur3":
            d1 = 0.1519
            a2 = -0.24365
            a3 = -0.21325
    ...
    def Forward(self,q):
        d1, a2, a3, d4, d5, d6 = self.get_params()
        T=[0]*16
        #00
        s1 = math.sin(q[0])
        c1 = math.cos(q[0])
...
def main():
    ...
    q2 = [1.6140010356903076, -3.6044371763812464, 1.4654970169067383, 2.211503028869629, -1.5317304770099085, -3.098450485860006]
    q3=[0,0,0,0,0,0]
