...
#         Cam.__init__(self)
        ...
        self.width = width
        self.height = height
        self.cam_LENTHRESHOLD = 400
        self.cam_WIDTHTHRESHOLD = 9
        # self.feature_line = []

    def set_cam_parameters(self, len, wid):
        self.cam_WIDTHTHRESHOLD = wid
        self.cam_LENTHRESHOLD = len
...
#        print(lines)
    ...
    def get_feature_line(self):
        print("line:", self.cur_lines[0])
        return self.cur_lines[0]
